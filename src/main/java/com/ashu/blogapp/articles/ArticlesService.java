...
import com.ashu.blogapp.articles.dtos.CreateArticleRequest;
import com.ashu.blogapp.articles.dtos.UpdateArticleRequest;
import com.ashu.blogapp.users.UserEntity;
import com.ashu.blogapp.users.UsersRepository;
...
public class ArticlesService {
    ...
    public ArticleEntity createArticle(CreateArticleRequest a,Long authorId){
        ...
        return articlesRepository.save(ArticleEntity.builder().title(a.getTitle()).
                body(a.getBody()).
                author(author).
                slug(a.getTitle().toLowerCase().replace("\\s+","-"))//TODO slugify
